...
with(subs, plot(Time, Global_active_power,
            type = "l", 
            xaxt = "n", xlab = "", 
...
with(subs, plot(Time, Sub_metering_1,
                type = "l", 
                xaxt = "n", xlab = "", 
                ylab="Energy sub metering"))
with(subs, lines(Time, Sub_metering_2, col = "red"))
with(subs, lines(Time, Sub_metering_3, col = "blue"))
legend("topright", lty=1, col= c("black", "blue", "red"),  
       legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"))
axis(1, at= timeList, 
     labels = dayList)

with(subs, plot(Time, Global_reactive_power,
                type = "l", 
                xaxt = "n", xlab = "datetime"))
